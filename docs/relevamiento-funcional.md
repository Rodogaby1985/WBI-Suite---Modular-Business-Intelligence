...
| Pedido rápido mayorista desde catálogo | Operación B2B / Ventas | Pedido rápido mayorista público | automatización | Activa visible | cliente B2B | Habilita selección de variantes, cantidad y agregado rápido desde el loop de productos. | Reduce fricción en pedidos grandes y acelera reposiciones. | includes/class-wbi-public-wholesale-quick-order.php (`wp_enqueue_scripts`), assets/js/wbi-public-wholesale-quick-order.js, modules/public-wholesale-quick-order/public-wholesale-quick-order.php | 717551b y rama `copilot/create-public-wholesale-module` referenciada en historial reciente |
