...
- Comparaciones/deltas: `.wbi-delta.positive|negative|neutral` con significado textual visible (`Subió`, `Bajó`, `Sin cambios`) y nota separada cuando la base comparada es cero
